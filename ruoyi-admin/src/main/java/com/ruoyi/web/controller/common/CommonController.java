...
public class CommonController
{
    ...
    @Autowired
    private ISysFileInfoService sys_file_info;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        try
        {
            ...
            sysFileInfo.setRealName(fileRealName);
            sysFileInfo.setShowName(showName);
            sysFileInfo.setFilePath(path);
            sys_file_info.insertSysFileInfo(sysFileInfo);
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SysFileInfo sysFileInfo = new SysFileInfo();
            sysFileInfo.setRealName(downloadName);
            List<SysFileInfo> fileList = sys_file_info.selectSysFileInfoList(sysFileInfo);
