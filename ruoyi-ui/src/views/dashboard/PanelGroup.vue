        ...
        <div class="card-panel-icon-wrapper icon-people" >
         ...
         <div class="card-panel-description">
          <div class="card-panel-text">
            <el-row>
              <el-button  type="primary" round @click="online">在线用户</el-button>
            </el-row>
          </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">
            <el-row>
              <el-button  type="success" round @click="notice">通知公告</el-button>
            </el-row>
          </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">
            <el-row>
              <el-button type="info" round @click="server">服务监控</el-button>
            </el-row>
          </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">
            <el-row>
              <el-button type="warning" round @click="work">待办任务</el-button>
            </el-row>
          </div>
