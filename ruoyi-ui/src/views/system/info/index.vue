...
<!--      <el-table-column label="文件路径" align="center" prop="filePath" />-->
      <el-table-column label="文件路径" align="center" prop="realName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文件名称" prop="realName">
          <el-input v-model="form.realName" placeholder="请输入文件名称" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDownload(row) {
      ...
      a.setAttribute("href","http://localhost:80"+process.env.VUE_APP_BASE_API+ "/common/download/resource?resource="+suffix+"/"+name)
      a.click()
    },
  }
};
