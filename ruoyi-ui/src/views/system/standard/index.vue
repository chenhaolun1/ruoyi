...
<!--      <el-form-item label="标准类别" prop="realName">-->
<!--        <el-input-->
...
<!--      </el-form-item>-->
      ...
      <el-form-item label="标准类别" prop="categoriesName">
        <el-input
    ...
    <el-table v-loading="loading" :data="standardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标准类别" align="center" prop="categoriesName" />
...
<script>
import { listStandard, getStandard, delStandard, addStandard, updateStandard, exportStandard } from "@/api/system/standard";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/standard/common/upload",
        // 上传的文件列表
        fileList: [],
      },
    };
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getStandard(fileId).then(response => {
    ...
    handleDownload(row) {
      ...
      a.setAttribute(
        ...
        "/system/standard/common/download/resource?resource=" +
        suffix +
        "/" +
        name
      );
