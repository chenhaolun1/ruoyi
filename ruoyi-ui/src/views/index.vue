<template>
  <div class="screen-container" :style="containerStyle">
    <header class="screen-header">
      ...
      <span class="title">信创适配云平台实时监控系统</span>
...
<script>
  import Hot from './map/components/Hot.vue'
  import Map from './map/components/Map.vue'
  import Rank from './map/components/Rank.vue'
  import Seller from './map/components/Seller.vue'
  import Stock from './map/components/Stock.vue'
  import Trend from './map/components/Trend.vue'
