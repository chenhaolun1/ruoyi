<template>
  <div>
    <div>
    <h2>适配需求人：{{form.createName}}</h2>
    <el-form  label-width="80px">
      <el-form-item label="适配需求类型" >
      ...
      <el-form-item label="开始时间">
        <el-input v-model="form.requirementStartTime"/>
      </el-form-item>
      <el-form-item label="结束时间">
        <el-input v-model="form.requirementEndTime"/>
      </el-form-item>
    </el-form>
    </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      getRequirement() {
        getRequirement(this.businessKey).then(response => {
    ...
    handleExport() {
      ...
      a.setAttribute("href","http://localhost:80"+process.env.VUE_APP_BASE_API+ "/workflow/requirement/common/download/resource?resource="+suffix+"/"+name)
      a.click()
    }
    }
  }
